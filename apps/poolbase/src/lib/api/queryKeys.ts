export const scopeKeys = {
  ...
  allByUser: (uid: string) => [...scopeKeys.allByUser(uid), uid] as const,
...
export const resourceKeys = {
  ...
  allByUser: (uid: string) => [...resourceKeys.allByUser(uid), uid] as const,
...
export const tagKeys = {
  ...
  allByUser: (uid: string) => [...tagKeys.allByUser(uid), uid] as const,
...
export const integrationKeys = {
  ...
  allByUser: (uid: string) => [...integrationKeys.allByUser(uid), uid] as const,
...
export const userKeys = {
  ...
  allByUser: (uid: string) => [...userKeys.allByUser(uid), uid] as const,
