...
alter table "public"."scope_tag" add constraint "scope_tag_pkey" PRIMARY KEY using index "scope_tag_pkey";

alter table "public"."scopes" add constraint "scopes_pkey" PRIMARY KEY using index "scopes_pkey";

alter table "public"."tags" add constraint "tags_pkey" PRIMARY KEY using index "tags_pkey";

alter table "public"."resource_tag" add constraint "resource_tag_resource_id_fkey" FOREIGN KEY (resource_id) REFERENCES resources(id) not valid;

alter table "public"."resource_tag" validate constraint "resource_tag_resource_id_fkey";

alter table "public"."resource_tag" add constraint "resource_tag_tag_id_fkey" FOREIGN KEY (tag_id) REFERENCES tags(id) not valid;

alter table "public"."resource_tag" validate constraint "resource_tag_tag_id_fkey";

alter table "public"."scope_tag" add constraint "scope_tag_scope_id_fkey" FOREIGN KEY (scope_id) REFERENCES scopes(id) not valid;

alter table "public"."scope_tag" validate constraint "scope_tag_scope_id_fkey";

alter table "public"."scope_tag" add constraint "scope_tag_tag_id_fkey" FOREIGN KEY (tag_id) REFERENCES tags(id) not valid;

alter table "public"."scope_tag" validate constraint "scope_tag_tag_id_fkey";

alter table "public"."scopes" add constraint "scopes_uid_fkey" FOREIGN KEY (uid) REFERENCES auth.users(id) not valid;

alter table "public"."scopes" validate constraint "scopes_uid_fkey";

alter table "public"."tags" add constraint "tags_uid_fkey" FOREIGN KEY (uid) REFERENCES auth.users(id) not valid;
