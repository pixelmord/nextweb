...
CREATE TRIGGER "handle_updated_integrations_at" BEFORE UPDATE ON "public"."integrations" FOR EACH ROW EXECUTE FUNCTION "extensions"."moddatetime"('updated_at');
...
CREATE TRIGGER "handle_updated_profiles_at" BEFORE UPDATE ON "public"."profiles" FOR EACH ROW EXECUTE FUNCTION "extensions"."moddatetime"('updated_at');
...
CREATE TRIGGER "handle_updated_resources_at" BEFORE UPDATE ON "public"."resources" FOR EACH ROW EXECUTE FUNCTION "extensions"."moddatetime"('updated_at');
